---
name: feature
description: 'Manage current feature workflow - start, review, explain or complete. Use when: feature workflow, load spec, start feature, review feature, test feature, explain changes, complete feature.'
...
Execute the requested action from the argument.
