...
description: 'List React component files and summarize each. Use when: list components, inventory components, audit components, summarize components.'
---
...
2. Find component files limited to `.tsx`, `.ts`, `.jsx`, and `.js`.
